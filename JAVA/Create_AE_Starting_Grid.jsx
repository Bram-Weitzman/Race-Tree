...
// Load JSON file
//var jsonFile = File("F:/AE Scripts/GetData/my_startgrid.json");
...
var initialYPosition = 425;// defualt 425


//Loop to create position numbers
for (var i = 0; i < numDrivers; i++) {  
   create_position_numbers(initialYPosition + (i * 60), i, newComp, 1500) // Default 70
}

//Loop to create name badges
for (var i = 0; i < numDrivers; i++) {  
   create_name_badge(initialYPosition + (i * 60), i, newComp, 1500); // Default 70
